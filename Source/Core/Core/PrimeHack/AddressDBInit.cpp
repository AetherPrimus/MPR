...
void init_db(AddressDB& addr_db) {
  ...
  addr_db.register_dynamic_address(Game::PRIME_1, "pitch", "player", {mrt1(0x3dc)});
  ...
  addr_db.register_dynamic_address(Game::PRIME_1_GCN, "pitch", "player", {rt(0x3ec, 0x3fc, 0)});
  ...
  addr_db.register_dynamic_address(Game::PRIME_2, "pitch", "player", {mrt1(0x5f0)});
  ...
  addr_db.register_address(Game::PRIME_2_GCN, "crosshair_color", 0x80736d30, 0x80738f90);
  ...
  addr_db.register_dynamic_address(Game::PRIME_3, "pitch", "player", {mrt1(0x784)});
