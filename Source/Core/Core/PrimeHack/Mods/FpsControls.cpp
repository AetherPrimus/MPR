...
void FpsControls::add_grapple_lasso_code_mp3(u32 func1, u32 func2, u32 func3) {
  ...
  add_code_change(func2 + 0x8, ori, "grapple_lasso_animation");
  add_code_change(func2 + 0xC, 0xC00B0000, "grapple_lasso_animation");  // lfs f0, 0(r11)
