...
const std::string hotkey_labels[] = {
    ...
    _trans("Toggle Developer Info"),
    _trans("Reload Entities Config"),
    _trans("Toggle Entity Visibility"),
    _trans("Move Time Forwards"),
    _trans("Holster Arm Cannon"),
    _trans("Cycle Through Dirt Textures"),
};
// clang-format on
...
const std::array<HotkeyGroupInfo, NUM_HOTKEY_GROUPS> groups_info = {
    {{_trans("General"), HK_OPEN, HK_EXIT},
     ...
     {_trans("PrimeHack"), HK_NOCLIP_TOGGLE, HK_CYCLE_WEATHERING }}
};
